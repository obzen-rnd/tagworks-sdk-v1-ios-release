    ...
    var queryItems: [URLQueryItem] {
        get {
            if let e_c = eventCategory {
                ...
                return [
                    URLQueryItem(name: URLQueryParams.siteId, value: siteId.URLEncodedString()),
                    URLQueryItem(name: URLQueryParams.userId, value: userId),
                    URLQueryItem(name: URLQueryParams.url, value: url?.absoluteString.URLEncodedString()),
                    URLQueryItem(name: URLQueryParams.urlReferer, value: urlReferer?.absoluteString.URLEncodedString()),
                    URLQueryItem(name: URLQueryParams.language, value: language?.addingPercentEncoding(withAllowedCharacters: .alphanumerics)?.URLEncodedString()),
                    ...
                    URLQueryItem(name: URLQueryParams.event, value: eventString.URLEncodedString())
                ]
            }
            ...
            return [
                ...
                URLQueryItem(name: URLQueryParams.screenSize, value: String(format: "%1.0fx%1.0f", screenResolution.width, screenResolution.height)),
                URLQueryItem(name: URLQueryParams.event, value: serializeEventString().URLEncodedString())
            ]
        }
    }
}
